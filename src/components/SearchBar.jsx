...
const SearchBar = () => {
    ...
    return (  
        <div className="flex bg-gray-200 shadow-md rounded-lg p-4 gap-2 overflow-hidden max-w-3xl w-full items-center">
            ...
            <a href="#">
                <button className="flex cursor-pointer items-center justify-center bg-gradient-to-r from-blue-600 to-sky-400 hover:from-blue-800 hover:to-sky-600 active:from-blue-800 active:to-sky-600 text-white px-4 py-2 rounded-lg font-semibold transition duration-300 hover:scale-105">
