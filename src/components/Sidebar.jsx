    ...
    return (  
        <div className='flex flex-col w-full gap-4 lg:sticky top-2'>
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
                <button className="flex items-center justify-center gap-4 px-auto py-2 bg-[#1877F2] hover:bg-[#166FE5] active:bg-[#166FE5] transition duration-300 rounded-md shadow-md hover:scale-105 active:scale-105 cursor-pointer"><FaFacebook className="h-5 w-5" /> <span>1.1K Fans</span></button>
                <button className="flex items-center justify-center gap-4 px-auto py-2 bg-[#E60023] hover:bg-[#cc001f] active:bg-[#cc001f] transition duration-300 rounded-md shadow-md hover:scale-105 active:scale-105 cursor-pointer"><FaPinterest className="h-5 w-5" /> <span>16.3K Fans</span></button>
                <button className="flex items-center justify-center gap-4 px-auto py-2 bg-[#000000] hover:bg-[#1a1a1a] active:bg-[#1a1a1a] transition duration-300 rounded-md shadow-md hover:scale-105 active:scale-105 cursor-pointer"><FaXTwitter className="h-5 w-5" /> <span>68.9K Fans</span></button>
                <button className="flex items-center justify-center gap-4 px-auto py-2 bg-[#F77737] hover:bg-[#e95f1f] active:bg-[#e95f1f] transition duration-300 rounded-md shadow-md hover:scale-105 active:scale-105 cursor-pointer"><FaInstagram className="h-5 w-5" /> <span>46.2K Fans</span></button>
                <button className="flex items-center justify-center gap-4 px-auto py-2 bg-[#FF0000] hover:bg-[#cc0000] active:bg-[#cc0000] transition duration-300 rounded-md shadow-md hover:scale-105 active:scale-105 cursor-pointer"><FaYoutube className="h-5 w-5" /> <span>6.8K Fans</span></button>
                <button className="flex items-center justify-center gap-4 px-auto py-2 bg-[#010101] hover:bg-[#1c1c1c] active:bg-[#1c1c1c] transition duration-300 rounded-md shadow-md hover:scale-105 active:scale-105 cursor-pointer"><FaTiktok className="h-5 w-5" /> <span>12.7K Fans</span></button>
            </div>
            <div className="flex flex-col items-center justify-center text-center bg-gray-200 gap-6 p-8">
                ...
                <div className="w-full">
                    <form action="">
                        ...
                        <button className="w-full uppercase bg-gradient-to-r from-blue-600 to-sky-400 hover:from-blue-800 hover:to-sky-600 active:from-blue-800 active:to-sky-600 p-3 font-semibold hover:bg-black transition-colors duration-300 shadow-sm cursor-pointer">Subscribe</button>
                    </form>
                </div>
            </div>
