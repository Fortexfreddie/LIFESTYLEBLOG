                    ...
                    <div className="flex flex-col xl:flex-row gap-10 w-full lg:w-full p-6">
                        <div className="w-full xl:w-[70%] flex flex-col gap-14 md:gap-10">
                                    ...
                                    <div key={index} className="w-full grid grid-cols-1 md:grid-cols-2 gap-8">
                                        ...
                                        <div className="flex flex-col justify-center gap-4">
                                            ...
                                            <div className="flex gap-2 items-center">
                                                <button onClick={() => navigate(`/ArticleDetail/${news.id}`)} className="text-xs uppercase bg-blue-600 hover:bg-blue-800 hover:scale-105 text-white px-4 py-2 transition-colors duration-300 shadow-sm cursor-pointer">View</button>
                                                <button onClick={() => removeItem(news.id)} className="text-xs uppercase bg-red-600 hover:bg-red-800 hover:scale-105 text-white px-4 py-2 transition-colors duration-300 shadow-sm cursor-pointer">Delete</button>
                                            </div>
                                        </div>
                                    </div>
                                ))
                            ...
                            <div className="w-full mt-4">
                                <button onClick={handleLoadMore} className="w-full uppercase bg-gradient-to-r from-blue-600 to-sky-400 hover:from-blue-800 hover:to-sky-600 p-3 font-semibold hover:bg-black transition-colors duration-300 shadow-sm cursor-pointer">load more</button>
                            </div>
                        </div>
